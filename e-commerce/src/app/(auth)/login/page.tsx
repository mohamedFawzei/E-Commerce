...
import AuthFooter from "../../_components/footer/auth-footer";
...
export default function LoginPage() {
  ...
  const onSubmit = async (data: LoginSchema) => {
    ...
    if (res?.message === "fail" && res?.errors) {
      ...
      // Handle success - maybe redirect to home
      ...
      <div className="w-full max-w-[350px] sm:max-w-[350px] p-6 border border-gray-300 rounded-lg">
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              ...
              render={({ field, fieldState }) => (
                <Field data-invalid={fieldState.invalid}>
                  ...
                  <Input
                    ...
                    placeholder="mohamedfawzeix@gmail.com"
                    autoComplete="on"
          ...
          <p className="text-[12px] leading-4 mt-4 text-gray-700">
            By continuing, you agree to omnibuy's{" "}
            <Link
              href="#"
